...
if check_access():
    ...
    st.markdown("""
        ...
        .strat-badge { padding: 3px 10px; border-radius: 5px; font-weight: bold; color: black; font-size: 12px; text-transform: uppercase; }
    ...
    with col_main:
        ...
        try:
            ...
            if not df.empty:
                ...
                if rsi > 72: strat, color = "DİKKAT: DOYUM", "#ff4b4b"
                elif rsi < 35: strat, color = "FIRSAT: ALIM", "#00ff88"
                else: strat, color = ("POZİTİF" if last_p > ma20 else "ZAYIF"), ("#00ff88" if last_p > ma20 else "#ffcc00")
                ...
                <div class='gurkan-pro-box'>
                    <div style='display:flex; justify-content:space-between; align-items:center;'>
                        <b style='color:#ffcc00;'>🤵 GÜRKAN PRO</b>
